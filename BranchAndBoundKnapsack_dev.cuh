...
class BranchAndBoundKnapsack_dev : public Mercator::DeviceApp<9,128,8192,524288000> {
   ...
   template <typename InputView>
   class __MTR_SINK_23691728 final : public Mercator::NodeFunction_Sink<SubProblem, InputView, THREADS_PER_BLOCK> {
   public:
      __device__
      __MTR_SINK_23691728(
                          Mercator::RefCountedArena * parentArena,
                          const BranchAndBoundKnapsack::__MTR_SINK_23691728::NodeParams* inodeParams,
                          const BranchAndBoundKnapsack::AppParams* iappParams
                         )
   ...
   private:
      ...
      const BranchAndBoundKnapsack::__MTR_SINK_23691728::NodeParams* const nodeParams;
      
      __device__
      const BranchAndBoundKnapsack::__MTR_SINK_23691728::NodeParams* getParams() const
      { return nodeParams; }
...
public:
   ...
   BranchAndBoundKnapsack_dev(size_t *tailPtr, const BranchAndBoundKnapsack::Params *params)
   {
      ...
      __MTR_SINK_23691728<Mercator::Queue<SubProblem>>* dSinkNodeFcn = new __MTR_SINK_23691728<Mercator::Queue<SubProblem>>(nullptr, &params->n__MTR_SINK_23691728[0], &params->appParams);
      assert(dSinkNodeFcn != nullptr);
      Mercator::Node_Queue<SubProblem, 0, 0, __MTR_SINK_23691728> * dSinkNode = new Mercator::Node_Queue<SubProblem, 0, 0, __MTR_SINK_23691728>(&scheduler, 0, 1, dA7node, 0, 1536, dSinkNodeFcn);
